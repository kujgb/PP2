...
#6 Increment the sequence with 3 (default is 1):

for x in range(2, 30, 3):
  print(x)

#7 Print all numbers from 0 to 5, and print a message when the loop has ended:
...
#8 Print each adjective for every fruit:
